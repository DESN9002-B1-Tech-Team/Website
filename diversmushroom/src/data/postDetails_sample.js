const postDetails = [
  {
    src: "/images/cardboard-mushroom.jpg",
    text: "Mushrooms can be grown on cardboard! Here's How...",
    label: "Tutorial",
    path: "/posts/mushrooms-and-cardboard",
    subtext: "The 5 edible mushrooms that are grown are Oyster mushrooms, Shiitake mushrooms, Wine cap mushrooms, Pioppino mushrooms and Lion's mane mushrooms...",
  },
  {
  ...
  {
    src: "/images/mushrooms-Massy-France.jpg",
  ...
  {
    src: "/images/mushroom-biggest.jpg",
  ...
  {
    src: "/images/mushroom-spore-reuse.jpg",
...
{
    src: "/images/mushroom-in-the-dark.jpg",
    text: "Benefits of eating mushroom",
    label: "Interesting Facts",
    path: "/posts/mushrooms-spore-reuse",
    subtext: "According to a research paper Mushroom intake and depression... Mushrooms contain numerous bioactive compounds that may be associated with reduced anxiety including vitamin... ",
  },
